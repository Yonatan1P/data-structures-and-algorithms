...
Write a function named templatingWithMustache that uses mustache to create
 the markup templates for each of the characters. Use the snippet as your 
 guide for creating your templates. Return an array of template strings. 
   ...
   const template = $('#template').html();
    ...
    let output = [];
     characters.forEach(character =>{
        let rendered = Mustache.render(template, character);
...
const getCourseKeys = (obj) => {
    ...
    return properties;// Solution code here...
};
...
const getHouses = (arr) => {
  ...
  arr.forEach(character => {
      let currentHome = character.house;
      houses.push(currentHome);
  });// Solution code here...
  return houses;
};
