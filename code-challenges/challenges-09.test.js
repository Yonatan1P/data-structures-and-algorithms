...
First, write a function called mapCurrentEvents that maps over the current events object,
 runs it through a constructor function and returns the resulting array.

The constructor function should be a stand alone function named Events and should have the
 following keys: 
* author
* categories
* summary
...
Next, write a function named getCurrentEvents that takes in the request and response as
 parameters. This function should call the mapCurrentEvents function and send the result
  to the front-end.
...
function getCurrentEvents(request, response){
  response.send(mapCurrentEvents());// Solution code here...
}

const mapCurrentEvents = () => {
    let mappedEvents = currentEvents.news.map(mapEvent => {
        return new Event(mapEvent)
    })
    return mappedEvents;// Solution code here...
}
...
Write a function named reversedString that takes in a string and returns a string with the 
letters in reverse order.

Note: You must use reduce for this challenge. You may not use the built-in .reverse() string
method.
------------------------------------------------------------------------------------------------ */
